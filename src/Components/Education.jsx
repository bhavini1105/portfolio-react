  ...
  <div className="row align-items-center">
    ...
    <div className="col-md-6">
      <div className="education-card">
        ...
        <p className="mb-0 text-white">Red And White Institute </p>
      </div>
      <div className="education-card">
        <small>2018 - 2022</small>
        <h5><i className="bi bi-person-fill" />Bachelor Degree in Computer Engeneering</h5>
        <p className="mb-0 text-white">S S Agrawal Institute </p>
      </div>
      <div className="education-card">
        <small>2016 - 2018</small>
        <h5><i className="bi bi-person-fill" />Higher Secondary</h5>
        <p className="mb-0 text-white">A B School Navsari</p>
      </div>
      <div className="education-card">
